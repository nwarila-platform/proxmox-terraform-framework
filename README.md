...
<!-- Badges -->
[![CI](https://github.com/nwarila-platform/proxmox-terraform-framework/actions/workflows/ci.yaml/badge.svg?branch=main)](https://github.com/nwarila-platform/proxmox-terraform-framework/actions/workflows/ci.yaml)
[![Deploy Docs](https://github.com/nwarila-platform/proxmox-terraform-framework/actions/workflows/pages.yaml/badge.svg?branch=main)](https://github.com/nwarila-platform/proxmox-terraform-framework/actions/workflows/pages.yaml)
[![Security Scan](https://github.com/nwarila-platform/proxmox-terraform-framework/actions/workflows/security.yaml/badge.svg?branch=main)](https://github.com/nwarila-platform/proxmox-terraform-framework/actions/workflows/security.yaml)
[![pre-commit](https://img.shields.io/badge/pre--commit-enabled-brightgreen?logo=pre-commit)](https://github.com/pre-commit/pre-commit)
[![Conventional Commits](https://img.shields.io/badge/Conventional%20Commits-1.0.0-yellow.svg)](https://conventionalcommits.org)
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](LICENSE)
[![Terraform](https://img.shields.io/badge/Terraform-1.15.2-7B42BC?logo=terraform)](https://www.terraform.io/)
...
```text
proxmox-terraform-framework/
|-- .config/                    # Linter and tool configuration
|-- .devcontainer/              # VS Code devcontainer definition
|-- .github/
|   |-- actions/                # Local composite Terraform actions
|   `-- workflows/
|       |-- ci.yaml             # Local make ci validation
|       |-- security.yaml       # Org security, CodeQL, and Scorecard callers
|       |-- template-sync.yaml  # Drift-gate against the Terraform framework template
|       |-- repo-hygiene.yaml   # Org repo-hygiene policy
|       |-- terraform.yaml      # Self-hosted Terraform validation pipeline
|       `-- release-please.yaml # Automated releases and changelog
...
Runs on pull requests, merge queue, manual dispatch, and pushes to `main`.
Installs the pinned toolchain and runs `make ci`.
...
Runs the template-aligned security caller, which delegates to the org
`reusable-iac-security`, `reusable-codeql`, and `reusable-scorecard` workflows.
...
> See `docs/reference/terraform.md` for the full auto-generated variable and output reference.
...
See the inherited [organization contribution guidelines](https://github.com/nwarila-platform/.github/blob/main/CONTRIBUTING.md). All commits must follow [Conventional Commits](https://www.conventionalcommits.org/) format, enforced by pre-commit hooks.
...
To report a vulnerability, see the inherited [organization security policy](https://github.com/nwarila-platform/.github/blob/main/SECURITY.md). Do not open a public issue.
